...
def image_import(folder_path, image_name):
    ...
    image_path = os.path.join(folder_path, image_name) # image path 
...
def gray_conversion(folder_path, imArray, image_name):
    """
    ...
    output_path = folder_path  + '/' + image_name + '_gray.png'
...
def reconstrucuted_images(folder_path, coeffs, n, wavelet, image_name):
    """
    ...
    output_path = folder_path  + '/' + image_name + '_prepared.png'
...
def cell_identification(folder_path, binary_image, imArrayG, image_name):
    ...
    # Save image
    output_path = folder_path + '/' + image_name + '_contours.png'
...
def main():
    folder_path = 'Programming/Dataset'
    ...
    for image in os.listdir(folder_path):
        ...
        # Convert image to grayscale and convert to 8-bit integer
        imArrayG = gray_conversion(folder_path, imArray, image_name)
        ...
        prepared_image = reconstrucuted_images(folder_path, coeffs, n, wavelet, image_name)
        ...
        result_filtered, filtered_contours = cell_identification(folder_path, binary_image, imArrayG, image_name)
